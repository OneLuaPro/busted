...
# Essentially reads bin/busted (the main script) and converts it into a C-header
# file for inclusion in busted.cpp. The contents of the generated header are pure
# hex values.
...
"#pragma once\n\n"
"static const unsigned char busted_source_bytes[] = {\n${FORMATTED_HEX}\n0x00\n};\n\n"
"static const unsigned int busted_source_size = sizeof(busted_source_bytes) - 1;\n"
)
